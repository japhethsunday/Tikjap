...
import { Pencil, RefreshCw, AlertTriangle, StopCircle } from "lucide-react";
...
function AssistantMessage({
  ...
  return (
    <div className="group flex flex-col items-start gap-1.5">
      ...
      {!isStreaming ? (
        <div className="ml-11 flex items-center gap-1 opacity-0 transition-opacity group-focus-within:opacity-100 group-hover:opacity-100">
          <CopyButton text={message.content} />
...
export function MessageItem({
  ...
  return <AssistantMessage message={message} onRegenerate={onRegenerate} showTimestamp={showTimestamp} />;
}